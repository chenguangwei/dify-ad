  ...
  return (
    ...
    >
      <div className="pb-6">
        ...
        <p
          className="bg-[linear-gradient(271deg,_var(--components-input-border-active-prompt-1,_#007AFF)_-12.85%,_var(--components-input-border-active-prompt-2,_#0BA5EC)_95.4%)] bg-clip-text text-transparent title-3xl-semi-bold"
        >
