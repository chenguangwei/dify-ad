...
const UpgradeCard: FC = () => {
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border-[0.5px] border-components-panel-border-subtle bg-components-panel-on-panel-item-bg py-3 pl-4 pr-3.5 shadow-xs backdrop-blur-[5px]">
      <div>
        <div className="bg-[linear-gradient(92deg,_var(--components-input-border-active-prompt-1,_#0BA5EC)_0%,_var(--components-input-border-active-prompt-2,_#007AFF)_99.21%)] bg-clip-text text-transparent title-md-semi-bold">{t('upgrade.uploadMultipleFiles.title', { ns: 'billing' })}</div>
